...
import { DroneAimRoutine } from "../../lore/hostiles/drones.js"
...
export class Floor0Arena0 extends ArenaScenario {
	...
	registerScenario() {
		this.universe.register(new StagedArenaScenarioRoutine(this.universe, [
			new WavesStage(0.3, 10, () => [ bossDrone(new Transform(this.universe.width * 0.5, this.universe.height * 0.95, -Math.PI / 4)) ]),
			new FightStage()
